...
locomotionQuant.distSimple{1,k} = (trapz(temp_timeS(1:temp_sampRate*60*10+1), temp_velocity(2:temp_sampRate*60*10+2)))/100; %Distance travelled during the first 15 min (used across recordings for comparison) in meters
